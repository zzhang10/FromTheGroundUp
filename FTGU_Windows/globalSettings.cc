...
const string global__mapDirectory ="C:\\Users\\zackz\\OneDrive\\Desktop\\FromTheGroundUp\\maps\\";
...
const string global__goldProtectedModded =
        "The Defender was like, \"Dude, that's my gold.\"";
...
const string global__FSProtectedModded =
        "The Defender was like, \"you can't take that ForceShield from me!\"";
...
const string global__noWalkModded1 =
        "Bruh, people don't just walk inside stuff like that.";
const string global__noWalkModded2 =
        "No no no no no, you can't go there, that's not how the game works.";
const string global__noWalkModded3 =
        "Walking that way is like a baby seal walking into a club.";
const string global__noUse = "There is nothing to use.";
const string global__noUseModded =
        "\"Watch this!\" you said, trying to use nothing and failing miserably.";
...
const string global__noAtkModded =
        "You made a fool out of yourself by frenziedly attacking at air.";
...
const string global__mercenaryHostileModded =
        "Oh boy, all the Mercenaries just got triggered.";
...
const string global__defenderMadDHModded =
        "That defender is REAL mad when you are near its Stash.";
const string global__defenderMadFSModded =
        "That defender got no chill as long as you are near the Force Shield.";

const string global__moddedMsg =
        "Would you like to add some mods to the game?\n\n"
        "   STANDARD FEATURES                   MODDED FEATURES\n\n"
...
const string global__modeMsg =
        ...
        "[p] Pleb mode: Enemies' attacks will do no damage\n"
        "[n] Normal mode: Regular gameplay\n"
        "[b] Brutal mode: Enemies' Atk and Def increase by 10% per level "
...
const string global__genMessage(string type, string name, int dmgDealt) {
    if (type == "playerAttack") { //Player Attack Enemy
        ...
        if (!global__modded) {
            return "The " + name + " attacked you for " + dmg + " damage.";
        }
      
        if (name == "Tankmaster") {
            return "The Tankmaster ran you over for " + dmg + " damage.";
        } else if (name == "Mercenary") {
            return "The Mercenary slashed you with his rapier and did "
            +dmg+" damage.";
        } else if (name == "Vindicator") {
            return "The Vindicator bullied you for " + dmg + " damage.";
        } else if (name == "Warlock") {
            return "The Warlock dealt " + dmg +
                " damage to you with its stone hammer.";
        } else if (name == "Defender") {
            return "The Defender knocked you over with his heavy shield. You took "
            + dmg + " damage.";
        } else if (name == "Ninja") {
            return "The Ninja threw a shuriken at you and did "
            +dmg +" damage.";
        } else if (name == "Xenosite") {
            return "The Xenosite bit you fiercely for "
                + dmg + " damage.";
        } else if (name == "Wizard") {
            return "The Wizard zapped you for " + dmg + " damage.";
        } else {
            return "The "+ name + " hit you for " + dmg + " damage.";
        }
    } else return "";
}
